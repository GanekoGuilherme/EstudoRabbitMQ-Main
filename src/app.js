...
typeorm_1.createConnection({ type: "mongodb", host: "localhost", port: 27017, database: "yt_node_main", entities: [product_1.Product], synchronize: true, logging: false }).then(function (db) {
